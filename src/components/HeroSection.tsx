  ...
  return (
    <div className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden bg-gradient-to-b from-[#003f5c] via-[#046b8a] to-[#05a2c2] text-white px-4 py-12">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div
          className="absolute bottom-20 right-10 w-96 h-96 bg-[#046b8a]/20 rounded-full blur-3xl animate-pulse"
          style={{ animationDelay: "1s" }}
        ></div>
        <div
          className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-[#003f5c]/10 rounded-full blur-3xl animate-pulse"
      ...
      <main className="relative z-10 pt-20 flex flex-col items-center gap-8 max-w-6xl mx-auto">
        ...
        <div className="relative">
          <h1
            className="text-5xl sm:text-7xl md:text-8xl lg:text-9xl font-extrabold 
        ...
        {/* Tagline */}
        <p
          className="text-xl md:text-2xl lg:text-3xl font-semibold text-center max-w-4xl
                        bg-gradient-to-b from-[#e2faff] via-[#ffffff] to-[#c7f4ff]
                        text-transparent bg-clip-text drop-shadow-lg px-6
                        leading-relaxed"
        >
          Dive into the world where dreams become true, hand in hand with us as we attempt to
          enlighten your path!
        </p>
        ...
        <div className="mt-8">
          ...
          >
            {/* Gradient background */}
            <span
              className="absolute inset-0 bg-gradient-to-r from-[#05a2c2] to-[#046b8a] 
                                group-hover:from-[#046b8a] group-hover:to-[#05a2c2] transition-all duration-300"
            ></span>

            {/* Glow effect */}
            <span
              className="absolute inset-0 bg-gradient-to-r from-[#a9e8ff] to-[#05a2c2] 
                                opacity-0 group-hover:opacity-100 blur-xl transition-opacity duration-300"
            ></span>

            {/* Border */}
            <span
              className="absolute inset-0 border-2 border-[#a9e8ff] rounded-full 
