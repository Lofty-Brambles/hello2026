      ...
      <div className="max-w-[1600px] mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8">
          ...
          <div className="lg:col-span-9 flex flex-col gap-24">
            ...
            <h2
              ref={titleRef}
              className="text-3xl sm:text-1xl md:text-2xl lg:text-3xl font-medium tracking-tight leading-[1.1]"
            >
              <span className="inline-block text-gray-400 mr-3">
              ...
              <span className="inline-block text-gray-400">
                committed to driving change through collaboration.
              </span>
              <span className="text-gray-400">
                {" "}
                Founded in 2010 at one of the oldest and most prestigious universities in the
                country,
                <span className="inline-block font-bold text-black mr-3">JADAVPUR UNIVERSITY,</span>
                we belong to the
                <span className="font-bold text-black mr-3"> Kolkata section of Region 10.</span>As
                <span className="inline-block font-bold text-black">
                  one of the most active student branches in our section,
                </span>{" "}
                together, we spark the fire of learning and innovation, thus building a passionate
                community that
              </span>
              <span className="inline-block text-gray-400">
                stands on sharing ideas and making impacts!
              </span>
            </h2>
