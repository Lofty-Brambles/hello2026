      ...
      <div className="max-w-6xl mx-auto mb-20">
        <div className="bg-white/15 backdrop-blur-md p-8 md:p-12 rounded-2xl shadow-2xl border border-white/20">
          <p className="text-lg md:text-xl lg:text-2xl leading-relaxed text-justify">
            At IEEE JUSB, we&apos;re more than just a student chapter—we&apos;re a dynamic community
            of innovators, creators, and problem-solvers committed to driving change through
            collaboration. Founded in 2010 at one of the oldest and most prestigious universities in
            the country, JADAVPUR UNIVERSITY, we belong to the Kolkata section of Region 10. As one
            of the most active student branches in our section, we are there to support you every
            step of the way whether you&apos;re starting and eager to learn, ready to present your
            ideas, or passionate about diving into the world of technology or design. Through
            hands-on workshops, engaging seminars, and other large-scale events thriving throughout
            the year we intend to bridge the gap between knowledge and real-world application.
            Together, we spark the fire of learning and innovation, thus building a passionate
            community that stands on sharing ideas and making impacts!
          </p>
        </div>
      </div>
