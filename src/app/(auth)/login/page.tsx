  ...
  return (
    <div className="flex min-h-screen items-center justify-center px-4 md:px-8 lg:px-16 ocean-bg text-white">
      <div className="hidden lg:flex flex-col text-center justify-center pt-12 pb-12 w-1/2">
        ...
        <h1 className="text-5xl font-extrabold bg-clip-text text-transparent bg-gradient-to-r from-cyan-200 via-blue-300 to-purple-400 animate-pulse drop-shadow-[0_0_8px_rgba(0,0,0,0.6)]">
      ...
      <div className="w-full sm:w-96 lg:w-1/2 flex justify-center">
        <Card
          className="w-full max-w-md shadow-2xl border border-white/30 
